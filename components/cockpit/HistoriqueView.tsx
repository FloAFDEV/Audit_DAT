...
const EVENT_TYPE_GROUPS: { key: string; label: string; types: AppEventType[] }[] = [
    ...
    { key: 'AUDIT', label: "Éléments d'audit", types: ['AUDIT_ITEM_ADDED', 'AUDIT_ITEM_REMOVED', 'AUDIT_ITEM_UPDATED', 'AUDIT_ITEM_ARCHIVED', 'AUDIT_ITEM_RESTORED'] },
...
const EVENT_ICON: Record<AppEventType, LucideIcon> = {
    ...
    AUDIT_ITEM_UPDATED: FilePenLine, AUDIT_ITEM_ARCHIVED: Archive, AUDIT_ITEM_RESTORED: ArchiveRestore,
