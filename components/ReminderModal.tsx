            ...
            >
                <div className="bg-white dark:bg-neutral-800 px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                    <div className="w-full">
                        ...
                        {/* Reminder Section */}
                        <div className="mt-5 pt-5 border-t border-dashed border-gray-200 dark:border-teal-700">
                            ...
                            <div className="mt-4 text-left">
                                ...
                                <input
                                    ...
                                    className="mt-1 block w-full rounded-md border-0 bg-white dark:bg-neutral-900 px-3 py-2 text-gray-900 dark:text-slate-100 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-teal-600 placeholder:text-gray-400 dark:placeholder:text-slate-500 focus:ring-2 focus:ring-inset focus:ring-teal-600 dark:focus:ring-teal-500 sm:text-sm sm:leading-6"
                                />
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-gray-50 dark:bg-neutral-800/50 dark:border-t dark:border-teal-700 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                    ...
                    <button
                        type="button"
                        onClick={onSkip}
                        className="mt-3 inline-flex w-full justify-center rounded-md bg-white dark:bg-neutral-700 px-3 py-2 text-sm font-semibold text-gray-900 dark:text-slate-200 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-teal-600 hover:bg-slate-100 dark:hover:bg-neutral-600 sm:mt-0 sm:w-auto"
                    >
