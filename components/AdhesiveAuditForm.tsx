  ...
  return (
    <div className="bg-white dark:bg-slate-800 shadow-lg rounded-xl overflow-hidden">
      <div className="p-6">
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            ...
            <button
                ...
                title={`Réinitialiser l'audit pour ${dat.name}`}
                aria-label={`Réinitialiser l'audit pour ${dat.name}`}
            >
      ...
      <ConfirmationModal
          ...
          title="Réinitialiser le DAT"
          message={`Êtes-vous sûr de vouloir réinitialiser toutes les vérifications pour ${dat.name} ?\n\nStation : ${station.name}\nDirection : ${directionName}`}
