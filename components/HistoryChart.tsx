...
const CustomTooltip = ({ active, payload, label }: any) => {
  if (active && payload && payload.length) {
    return (
      <div className="bg-white dark:bg-neutral-800 p-3 border border-slate-200 dark:border-teal-700 shadow-lg rounded-lg">
...
export const HistoryChart: React.FC<HistoryChartProps> = ({ data = [] }) => {
  ...
  return (
    <div className="h-64 w-full mb-8 bg-white dark:bg-neutral-800 p-4 rounded-xl shadow-sm border border-slate-200 dark:border-teal-700">
