...
const MaintenanceListModal: React.FC<MaintenanceListModalProps> = ({ isOpen, onClose, title, items }) => {
    ...
    return (
        ...
        >
            <div
                className="relative transform flex flex-col overflow-hidden rounded-lg bg-white dark:bg-neutral-800 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-4xl h-[90vh]"
                onClick={(e) => e.stopPropagation()}
            >
                <div className="bg-white dark:bg-neutral-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4 border-b border-gray-200 dark:border-teal-700 flex-shrink-0">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-2 self-end sm:self-auto">
                            <button
                                ...
                                className="inline-flex items-center gap-2 px-3 py-1.5 text-sm font-medium rounded-md bg-slate-100 hover:bg-slate-200 text-slate-700 dark:bg-neutral-700 dark:hover:bg-neutral-600 dark:text-slate-200 transition-colors"
                            ...
                            <button
                                onClick={onClose}
                                className="p-2 rounded-full text-gray-400 hover:bg-gray-100 dark:hover:bg-neutral-700 transition-colors"
                                aria-label="Fermer"
                            >
                                <X className="h-6 w-6" />
                            </button>
                    ...
                    {sortedItems.length === 0 ? (
                        ...
                        <ul className="divide-y divide-gray-200 dark:divide-teal-700">
                            {sortedItems.map((item, index) => {
                                ...
                                return (
                                    <li key={index} className="p-4 hover:bg-slate-50 dark:hover:bg-neutral-800/50 transition-colors">
                                        ...
                                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-2">
                                            ...
                                            {item.context && (
                                                <div className="flex items-center">
                                                    ...
                                                    <span className="text-sm font-semibold text-slate-600 dark:text-slate-300 bg-slate-100 dark:bg-neutral-700 px-2 py-0.5 rounded">
                                                        {item.context}
                                                    </span>
                                                </div>
                                            )}
                                        ...
                                        <div className="flex items-start gap-3 pl-1 ml-[2px] border-l-2 border-gray-100 dark:border-teal-700/50">
                                            <div className="mt-0.5 p-1.5 bg-slate-100 dark:bg-neutral-700 rounded-md flex-shrink-0" title={item.moduleName}>
                                            ...
                                            <div>
                                                ...
                                                {item.photo_base64 && (
                                                    <img
                                                        ...
                                                        className="mt-2 w-24 h-24 rounded-md object-cover shadow-sm border border-gray-200 dark:border-teal-700"
                ...
                <div className="bg-gray-50 dark:bg-neutral-800/50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 border-t border-gray-200 dark:border-teal-700 flex-shrink-0 gap-2">
                    <button
                        type="button"
                        onClick={onClose}
                        className="inline-flex w-full justify-center rounded-md bg-white dark:bg-neutral-700 px-3 py-2 text-sm font-semibold text-gray-900 dark:text-slate-200 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-teal-600 hover:bg-gray-50 dark:hover:bg-neutral-600 sm:w-auto"
                    >
                        Fermer
                    </button>
                    <button
