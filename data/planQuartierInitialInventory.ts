...
//
// Points d'incertitude explicitement documentés (jamais résolus par une
// supposition silencieuse) :
//  - Jean-Jaurès est un pôle d'échange Ligne A / Ligne B : le côté exact
//    n'est pas connu, les entrées sont placées côté Ligne A avec une
//    note dans `comment` — à corriger au premier passage terrain.
//  - Arènes est un pôle d'échange Ligne A / Tram T1 : même incertitude,
//    placé côté Ligne A avec la même note.
//  - Les codes "2026", "2026b", "N2026" ne sont pas interprétés (millésime
//    ou lot d'impression inconnu) : conservés tels quels dans `comment`,
//    jamais traduits en une donnée structurée devinée.
// =================================================================
...
export const PLAN_QUARTIER_INITIAL_INVENTORY: PlanQuartierInitialEntry[] = [
    ...
    { stationName: 'François Verdier', line: 'B', modelId: 'pdq-78x100', quantity: 1, comment: 'Réf. terrain : 2026' },
    {
        ...
        comment: 'Réf. terrain : N2026. Pôle d\'échange A/B — côté exact (A ou B) à confirmer sur le terrain.',
    },
    {
    ...
    { stationName: 'Jean-Jaurès', line: 'A', modelId: 'pem3d-120x80', quantity: 1, comment: 'JEAN_JAURES_120X80_V05_tisseo_v3_16-06-2026_imp. Pôle d\'échange A/B — côté exact à confirmer.' },
    ...
    { stationName: 'Arènes', line: 'A', modelId: 'pem3d-120x80', quantity: 3, comment: 'Pôle d\'échange A/T1 — côté exact (A ou T1) à confirmer sur le terrain.' },
];
