...
export const LINE_C_STATIONS: Partial<Station>[] = [
    ...
    { id: 'sta-c-6', name: 'Sept Deniers', isFuture: true },
    ...
    { id: 'sta-c-10', name: 'Toulouse-Lautrec', isFuture: true },
    { id: 'sta-c-11', name: 'Raynal', isFuture: true },
    { id: 'sta-c-12', name: 'Bonnefoy', isFuture: true },
    { id: 'sta-c-13', name: 'Marengo-SNCF', isFuture: true, lieuName: 'Marengo-SNCF' },
    { id: 'sta-c-14', name: 'François Verdier', isFuture: true, lieuName: 'François Verdier' },
    { id: 'sta-c-15', name: 'Jean-Rieux', isFuture: true },
    { id: 'sta-c-16', name: 'Côte Pavée', isFuture: true },
    { id: 'sta-c-17', name: 'L\'Ormeau', isFuture: true },
    { id: 'sta-c-18', name: 'Montaudran', isFuture: true },
    { id: 'sta-c-19', name: 'Aerospace Campus', isFuture: true },
    { id: 'sta-c-20', name: 'Labège Enova', isFuture: true },
    { id: 'sta-c-21', name: 'Labège Gare', isFuture: true },
];
