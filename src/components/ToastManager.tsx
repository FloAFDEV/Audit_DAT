...
// FIX: Added a dedicated function for displaying error toasts.
// This provides a consistent way to show errors, similar to `showSuccessToast`,
// and avoids misusing `showPromiseToast` for simple error messages.
/**
